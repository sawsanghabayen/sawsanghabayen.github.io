                  ...
                  <form  action="process_employee_login.php" method="post" >
                        ...
                        <div class="textbox-wrap">
                            <div class="input-group">
                                ...
                                <input type="text" id="email" name="email"  required="required" class="form-control" placeholder="Email">
                            </div>
                        </div>
                        <div class="textbox-wrap">
                            <div class="input-group">
					...
					<div class="login-bottom">
					 ...
					 <div class="social-icons">
						...
						<h4>Don,t have an Account? <a href="registers.php"> Register Now!</a></h4>
					 </div>
		           </div>
                </div>
         </div>
